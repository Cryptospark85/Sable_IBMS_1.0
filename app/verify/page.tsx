        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_500px_at_50%_200px,#C9EBFF,transparent)]"></div>
            ...
            <Card className="w-[380px] px-5">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>We have set a verification link to your email address</CardDescription>
                    <CardContent>
                        <div className="mt-4 rounded-md bg-yellow-50 border-yellow-300 p-4">
                            <div className="flex items-center">
                                <AlertCircle className="size-5 text-yellow-400" />

                                <p className="text-sm font-medium text-yellow-500 ml-3">Check your spam folder</p>
                            </div>
                        </div>
                        </CardContent>
                        <CardFooter>
