...
export function CreateInvoice({ address, email, lastName, firstName}: iAppProps) {
               ...
               <form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>  
                ...
                <div className=" grid md: grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <div className="flex">
                            <span className="px-3 border border-r-0 rounded-l-md bf-muted flex items-center" >#</span>
                            <Input 
                    ...
                    <div>
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="ZAR">ZUID AFRIKA RAND -- ZAR</SelectItem>
                ...
                <div className="grid md:grid-col-2 gap-6 mb-6">
                    <div>
                        <Label>From</Label>
                ...
                <div className="flex items-center justify-end mt-6">
                    <div>
                        <SubmitButton text="Generate & Submit invoice to client"/>
                    </div>
                </div>
                </form>
            </CardContent>
